...
\Huge\textit{An Application of Formal Semantics to a Real-World Protocol}\\[1cm] % Subtitle
...
\item Describe TFTP's operational semantics.
...
<BLOCK\_NUM> ::= <BYTE> <BYTE>

<ERROR\_CODE> ::= <BYTE> <BYTE>
...
<PKT\_RRQ> ::= <OP\_RRQ> <STRING> <NUL> <STR\_MODE> <NUL>

<PKT\_WRQ> ::= <OP\_WRQ> <STRING> <NUL> <STR\_MODE> <NUL>

<PKT\_DATA> ::= <OP\_DATA> <BLOCK\_NUM> <PAYLOAD>

<PKT\_ACK> ::= <OP\_ACK> <BLOCK\_NUM>

<PKT\_ERROR> ::= <OP\_ERROR> <ERR\_CODE> <ERR\_MSG> <NUL>
